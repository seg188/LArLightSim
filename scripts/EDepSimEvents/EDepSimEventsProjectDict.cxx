...
namespace ROOT {
   static TClass *_Dictionary();
   static void _TClassManip(TClass*);
   static void *new_(void *p = 0);
   static void *newArray_(Long_t size, void *p);
   static void delete_(void *p);
   static void deleteArray_(void *p);
   static void destruct_(void *p);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("", "__pair_base_string_vector_TG4HitSegment___.h", 21,
                  typeid(::), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &_Dictionary, isa_proxy, 4,
                  sizeof(::) );
      instance.SetNew(&new_);
      instance.SetNewArray(&newArray_);
      instance.SetDelete(&delete_);
      instance.SetDeleteArray(&deleteArray_);
      instance.SetDestructor(&destruct_);

      ::ROOT::AddClassAlternate("","__pair_base<string,vector<TG4HitSegment> >");
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::*)
   {
      return GenerateInitInstanceLocal((::*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::*)0x0)->GetClass();
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_(void *p) {
      return  p ? new(p) :: : new ::;
   }
   static void *newArray_(Long_t nElements, void *p) {
      return p ? new(p) ::[nElements] : new ::[nElements];
   }
   // Wrapper around operator delete
   static void delete_(void *p) {
      delete ((::*)p);
...
} // end of namespace ROOT for class ::
...
"/home/stephen/miniconda3/envs/hex/include",
"/home/stephen/miniconda3/envs/hex/etc/",
"/home/stephen/miniconda3/envs/hex/etc//cling",
"/home/stephen/miniconda3/envs/hex/include/",
"/home/stephen/hex//include",
"/home/stephen/miniconda3/envs/hex/include",
"/home/stephen/miniconda3/envs/hex/include/",
"/home/stephen/hex/berk/sim/scripts/EDepSimEvents/",
0
    };
...
"__pair_base<string,vector<TG4HitSegment> >", payloadCode, "@",
nullptr
};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("EDepSimEventsProjectDict",
        ...
        TriggerDictionaryInitialization_EDepSimEventsProjectDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
